...
```{r table1}
library(table1)
t<-table1(~activetb+mantoux_bin+mantoux_result+igrapos+qfngit_tbag_nil+contact+age+sex+prevtbdiag+prevbcg+bmi+MotherGrossMonthlyIncome +FatherGrossMonthlyIncome+GuardianGrossMonthlyIncome+followup,data=d2)
...
Curves using normalizatied figures also show strange shape
